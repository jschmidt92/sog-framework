 ...
 * 3: Number of targets destroyed to complete the task <NUMBER>
 ...
 * 6: Number of seconds before targets escape to fail the task <NUMBER>
 *
 * Return Value:
 * Boolean of success <BOOL>
 *
 * Example:
 * [[target1, target2], "task1", 1, 2, false, false, 45] call SOG_destroy_fnc_checkTaskConditions
 *
 * Public: Yes
 */
