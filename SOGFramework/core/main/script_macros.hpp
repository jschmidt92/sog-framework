...
#define PREP(var1) TRIPLES(ADDON,fnc,var1) = compile preProcessFileLineNumbers 'PATHTO_SYS(SOGFramework,core,COMPONENT,functions,DOUBLES(fnc,var1))'
#define PREPMAIN(var1) TRIPLES(PREFIX,fnc,var1) = compile preProcessFileLineNumbers 'PATHTO_SYS(SOGFramework,core,COMPONENT,functions,DOUBLES(fnc,var1))'

#define CCOMP(var1) QUOTE(call compile preProcessFileLineNumbers var1)
#define PATH_PRE(var1) CCOMP('SOGFramework\core\var1\XEH_PreInit.sqf')
#define PATH_POST(var1) CCOMP('SOGFramework\core\var1\XEH_PostInit.sqf')
#define PATH_POST_CLIENT(var1) CCOMP('SOGFramework\core\var1\XEH_PostInitClient.sqf')
#define PATH_POST_SERVER(var1) CCOMP('SOGFramework\core\var1\XEH_PostInitServer.sqf')

#define MSG_SYS(LEVEL,MESSAGE) format ["[SOG %1] %2", LEVEL, MESSAGE]
